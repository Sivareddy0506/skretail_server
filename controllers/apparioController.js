...
exports.uploadChunk = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      'SELECT asin FROM appario WHERE asin = ANY($1::text[])',
      [asins]
    );
    ...
    const insertQuery = `
      INSERT INTO appario 
      (asin, name_of_the_commodity, net_quantity, MRP, month_and_year_of_manufacture, manufactured_and_packed_by, marketed_by, contact_customer_care_executive_at, unit_sale_price, made_in_india, barcode, created_at, updated_at)
      VALUES %L
    `;
